...
Xframes4Info=dir('debris_flow_newest_cut'); % put in the name of the folder we get the frames from
X={};
[n,~]=size(Xframes4Info);
for j=1:n
...
Waterhvideo=VideoWriter('debris_flow_newest_top_pink_cut4'); % Name of the movie
